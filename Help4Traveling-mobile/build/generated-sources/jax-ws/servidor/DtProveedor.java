 ...
 *         &lt;element name="servicio" type="{http://servidor/}dtServicio" maxOccurs="unbounded" minOccurs="0"/>
...
public class DtProveedor {
    ...
    protected List<DtServicio> servicio;
     ...
     * 
     */
    public List<DtServicio> getServicio() {
        if (servicio == null) {
            servicio = new ArrayList<DtServicio>();
        }

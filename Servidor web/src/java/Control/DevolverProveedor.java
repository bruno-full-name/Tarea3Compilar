...
@WebServlet(name = "DevolverProveedor", urlPatterns = {"/DevolverProveedor"})
public class DevolverProveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if(request.getParameter("listProv") != null){
                ...
                request.getRequestDispatcher("consultarProvVisitante.jsp").forward(request, response);
            }
        } finally { out.close(); }
    }
